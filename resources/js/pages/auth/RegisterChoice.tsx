...
export default function RegisterChoice() {
  return (
    <>
      <Head title="Pilih Daftar" />

      {/* Animasi lembut + guard aksesibilitas */}
      <style>{`
            ...
            >
              <div className="flex h-full items-start gap-4">
                <div
                  ...
                  aria-hidden="true"
                >
                  <i className="fas fa-user-plus text-[20px] sm:text-[22px]" />
                </div>
                ...
                <div className="flex min-h-[170px] flex-1 flex-col">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Buat akun untuk memesan layanan perbaikan perangkat.
                  </p>
            ...
            >
              <div className="flex h-full items-start gap-4">
                ...
                <div className="flex min-h-[170px] flex-1 flex-col">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Daftar untuk menerima permintaan, kirim penawaran, dan kelola pekerjaan.
                  </p>

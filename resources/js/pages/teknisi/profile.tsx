        ...
        <div className="min-h-screen bg-gray-100/50">
            ...
            <footer className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t z-30">
                <nav className="grid grid-cols-4 h-16">
                    ...
                    <Link href="/teknisi/profile" className="flex flex-col items-center justify-center gap-1 text-xs text-gray-600" style={{ color: PRIMARY }}><i className="fas fa-user-circle text-xl"></i><span>Profil</span></Link>
                </nav>
            </footer>
...
export default function Index() {
    ...
    // --- [REVISI FINAL] --- Style input yang jauh lebih tegas dan jelas

      ...
      <div className="relative min-h-[100svh] overflow-hidden bg-white">
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-md text-center">
            ...
            <h1 className="mt-4 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Daftar Pengguna</h1>
            <p className="mt-2 text-gray-600">Buat akun untuk memesan layanan perbaikan perangkat.</p>
          </div>
          ...
          <div className="mx-auto mt-6 max-w-md">
            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-7">
              <form onSubmit={submit} className="space-y-4" noValidate>
                {/* Nama */}
                <div>
                  <label htmlFor="name" className="mb-1 block text-sm font-medium text-gray-800">Nama Lengkap</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border px-3 py-2 pl-10 outline-none transition focus:border-gray-300
                                  focus:ring-2 focus:ring-[var(--p)] ${errors.name ? "border-red-300 ring-2 ring-red-200" : "border-gray-200"}`}
                ...
                {/* Email */}
                <div>
                  <label htmlFor="email" className="mb-1 block text-sm font-medium text-gray-800">Email</label>
                  <div className="relative">
                    <span className="pointer-events-none absolute inset-y-0 left-0 grid w-10 place-items-center text-gray-400" aria-hidden="true">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border px-3 py-2 pl-10 outline-none transition focus:border-gray-300
                                  focus:ring-2 focus:ring-[var(--p)] ${errors.email ? "border-red-300 ring-2 ring-red-200" : "border-gray-200"}`}
                ...
                {/* Password */}
                <div>
                  <label htmlFor="password" className="mb-1 block text-sm font-medium text-gray-800">Password</label>
                  <div className="relative">
                    <span className="pointer-events-none absolute inset-y-0 left-0 grid w-10 place-items-center text-gray-400" aria-hidden="true">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border px-3 py-2 pl-10 pr-10 outline-none transition focus:border-gray-300
                                  focus:ring-2 focus:ring-[var(--p)] ${errors.password ? "border-red-300 ring-2 ring-red-200" : "border-gray-200"}`}

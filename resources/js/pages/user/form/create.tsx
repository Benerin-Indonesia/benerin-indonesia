...
export default function Buat({ auth, initialCategory, categories }) {
  const { data, setData, post, processing, errors } = useForm({
    ...
    description: "",
    scheduled_for: "",
    image: null as File | null, // <-- Untuk gambar, nilai awalnya adalah null
    error_notif: ""
  });
          ...
          >
            ...
            <form onSubmit={submit} className="p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="rounded-xl border border-gray-200 p-5 shadow-sm md:col-span-1">
                  ...
                  <div className="relative mt-2">
                    ...
                    <select
                      ...
                      className="block w-full rounded-lg border border-gray-200 bg-gray-50/50 py-2.5 pl-10 pr-3 text-sm shadow-sm focus:border-transparent focus:ring-2"
                ...
                <div className="rounded-xl border border-gray-200 p-5 shadow-sm md:col-span-1">
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      className="block w-full rounded-lg border border-gray-200 bg-gray-50/50 py-2 pl-10 pr-3 text-sm shadow-sm focus:border-transparent focus:ring-2"
                      style={{ '--tw-ring-color': SECONDARY } as React.CSSProperties}
                    />
                  </div>
                ...
                <div className="rounded-xl border border-gray-200 p-5 shadow-sm md:col-span-2">
                  ...
                  <div className="mt-2">
                    <textarea
                      ...
                      className="block w-full rounded-lg border border-gray-200 bg-gray-50/50 p-3 text-sm shadow-sm focus:border-transparent focus:ring-2"
                ...
                <div className="rounded-xl border border-gray-200 p-5 shadow-sm md:col-span-2">
                  <label htmlFor="image" className="block text-sm font-medium leading-6 text-gray-700">
                    Foto Pendukung (Opsional)
                  </label>
                  <div className="mt-2">
                    <input
                  ...
                  {/* Pastikan error_key disesuaikan menjadi 'image' */}
